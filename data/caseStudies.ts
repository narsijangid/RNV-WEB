export const caseStudies = [
  {
    ...
    testimonial: `"Rinovea didn't disappear after the MVP was built. They continued to work with us to fix bugs and make improvements based on user feedback."`,
  ...
  },
  {
    ...
    description:
      "Rinovea designed, trained, built & deployed an AI-powered personalized slide deck creation & analytics SaaS platform from scratch in ~8 weeks.",
    features: [
  ...
  },
  {
    ...
    description:
      "Rinovea designed, developed and deployed Veerview AI, a prospecting & data enrichment SaaS for outbound sales —  12 weeks, team of 3.",
    features: [
    ...
    testimonial: `"Communication is free-flowing and Veerview can almost always get a hold of someone on Rinovea’s team throughout the day."`,
  ...
  },
  {
    ...
    description:
      "Rinovea designed, developed & launched the SaaS MVP from scratch in 8 weeks in late-2023. Scaled until it crossed several thousand paying users. Then, transferred it over to the in-house tech team.",
    features: [
    ...
    testimonial: `"Rinovea was very professional and provided excellent support throughout the entire process."`,
  ...
  },
  {
    ...
    testimonial: `"Rinovea's team was understanding about this and did not get discouraged when new bugs were found."`,
